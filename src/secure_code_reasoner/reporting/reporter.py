...
class Reporter:
    ...
    def report_fingerprint(self, fingerprint, output_path: Optional[Path] = None) -> str:
    ...
    def report_agent_findings(self, report, output_path: Optional[Path] = None) -> str:
    ...
    def report_trace(self, trace, output_path: Optional[Path] = None) -> str:
