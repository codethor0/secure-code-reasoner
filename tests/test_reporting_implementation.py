"""Unit tests for reporting subsystem implementation."""
...
class TestJSONFormatter:
    ...
    def test_format_fingerprint(self, sample_fingerprint: RepositoryFingerprint) -> None:
        """Test JSON formatting of fingerprint."""
    ...
    def test_format_agent_report(self, sample_agent_report: AgentReport) -> None:
        """Test JSON formatting of agent report."""
        formatter = JSONFormatter()
    ...
    def test_format_trace(self, sample_trace: ExecutionTrace) -> None:
        """Test JSON formatting of trace."""
        formatter = JSONFormatter()
...
class TestTextFormatter:
    ...
    def test_format_fingerprint(self, sample_fingerprint: RepositoryFingerprint) -> None:
        """Test text formatting of fingerprint."""
    ...
    def test_format_agent_report(self, sample_agent_report: AgentReport) -> None:
        """Test text formatting of agent report."""
        formatter = TextFormatter()
        output = formatter.format_agent_report(sample_agent_report)
...
class TestReporter:
    ...
    def test_reporter_agent_report(self, sample_agent_report: AgentReport, tmp_path: Path) -> None:
    ...
    def test_reporter_trace(self, sample_trace: ExecutionTrace, tmp_path: Path) -> None:
